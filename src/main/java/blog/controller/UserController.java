...
public class UserController extends BaseController {
	...
	public AjaxResult addUser(HttpServletRequest request, HttpServletResponse response) {
		...
		Integer levelIn = new Integer(level);  
		String des = request.getParameter("des");
		String tel = request.getParameter("tel");
		String address = request.getParameter("address");
		user.setName(name);
		user.setPassword(password);
		user.setLevel(levelIn);
		user.setDes(des);
		user.setTel(tel);
	...
	public AjaxResult createUserAction(String username, String password, String des, String tel, String address) {
	...
	public AjaxResult getUserList(@RequestParam(value = "level", required = false) Integer level,
	...
	public AjaxResult updateUserDetails(@RequestBody UserEditDetails userEditDetails, HttpServletRequest request) {
